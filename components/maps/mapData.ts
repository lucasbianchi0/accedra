...
const raw: Omit<Point, "x" | "y">[] = [
  ...
  { id: "rosario", city: "Rosario",       province: "Santa Fe",               client: "Andreani",          service: "Networking",      detail: "Conectividad y ciberseguridad para el centro logístico, con monitoreo proactivo y continuidad garantizada.", color: "#f97316", image: px(4682189) },
