...
export const en: Dict = {
  ...
  contact: {
    ...
    formSubtitle: "No sales pitch: a specialist reviews it and tells you if we can solve it.",
    fieldName: "Name",
    fieldCompany: "Company",
    fieldEmail: "Corporate email",
    fieldService: "Service of interest",
    fieldMessage: "How can we help you? (optional)",
    placeholderName: "John Smith",
    placeholderCompany: "My Company Inc.",
    placeholderEmail: "john@company.com",
    placeholderMessage: "If you'd like, tell us briefly about your case...",
  ...
  events: {
    speakers: "Speakers",
    registerTitle: "Save your spot",
    registerSub: "Leave your email and we will send you the confirmation with a calendar invite.",
    emailPlaceholder: "you@company.com",
    submit: "Register",
    sending: "Registering…",
    successTitle: "You are registered!",
    successMail: "We sent the confirmation to",
    successNoMail: "Your registration is saved, but we could not send the email. We will reach out before the event.",
    errorFull: "This event is fully booked.",
    errorClosed: "Registration for this event is closed.",
    errorRate: "We received several attempts in a row. Please try again in a few minutes.",
    errorEmail: "Please check the email address: something seems to be missing.",
    errorGeneric: "We could not register you. Please try again in a moment.",
    privacy: "We only use your email for this event. We never share it.",
    doneMessage: "This event has already taken place. Check the upcoming ones in the list.",
    all: "All",
    noneInCategory: "No events in this category yet.",
    // Las soluciones, con los slugs de /soluciones/<slug>.
    categories: {
      networking: "Networking",
      "firma-biometrica": "Biometric signature",
      consultoria: "Consulting",
      seguridad: "Cybersecurity",
      "software-ai": "AI & Software",
    },
    tab: "Events",
    drawerSub: "Workshops and training on the technologies we deploy every day.",
    participate: "Join",
    close: "Close",
    ...
    register: "Register",
    contactToRegister: "Ask about registration",
  ...
  footer: {
    ...
    companyItems: ["About Accedra", "Partners", "Clients", "Resources", "Contact"],
  ...
  solution: {
    ...
    // Brochure — the hero's inline link.
    brochureCta: "Download the brochure (PDF)",
    brochureEmail: "you@company.com",
    brochureSend: "Get the PDF",
    brochureNote: "No strings attached. We never share your email.",
    brochureReady: "Download the PDF",
    brochureSentTo: "We also sent it to",
    brochureError: "We couldn't send it. Please try again in a moment.",
    brochureRate: "You requested it recently. Check your inbox or try again later.",
    brochureEyebrow: "Brochure",
    brochureBody: "What the solution covers, the deliverables of each stage and real implementation cases.",
    brochureChips: ["What's included", "Deliverables", "Real cases"],
    brochureClose: "Close",
  },
};
